...
// Enhanced fallback sanitization function
...
// Safe DOMPurify import with enhanced fallback
let DOMPurify;
if (typeof window !== 'undefined') {
  ...
  try {
    ...
    console.warn('DOMPurify server-side setup failed, using enhanced fallback');
    DOMPurify = createFallbackSanitizer();
  }
}
